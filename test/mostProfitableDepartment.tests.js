describe('mostProfitableDepartment function test', function () {
    it('mostProfitableDepartment should return the most profitable department for dataset1', function () {
        var salesData = [
    ...
    it('mostProfitableDepartment should return the most profitable department for dataset2', function () {
        var salesData2 = [
    ...
    it('mostProfitableDepartment should return the most profitable day for a department for dataset1', function () {
        var salesData = [
            { department: 'hardware', sales: 4500, day: 'Monday' },
            { department: 'outdoor', sales: 1500, day: 'Monday' },
            { department: 'carpentry', sales: 5500, day: 'Monday' },
    ...
    it('mostProfitableDepartment should return the most profitable day for a department for dataset2', function () {
        var salesData2 = [
            { department: 'electronics', sales: 4500, day: 'Monday' },
            { department: 'outdoor', sales: 1500, day: 'Monday' },
            { department: 'carpentry', sales: 5500, day: 'Monday' },
